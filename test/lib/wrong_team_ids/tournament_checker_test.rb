...
module WrongTeamIds
  class TournamentCheckerTest < ActiveSupport::TestCase
    fixtures :tournaments, :towns, :seasons
    ...
    def setup
      ...
      town = towns(:town_1)
      @team_2 = Team.create(id: 2, title: "Team 2", town:)
      @team_3 = Team.create(id: 3, title: "Team 3", town:)
      @team_4 = Team.create(id: 4, title: "Team 4", town:)

      (1..20).each do |i|
        Player.create(id: i, first_name: "Player", last_name: i.to_s)
      end
    end
    ...
    def create_tournament_rosters_for_team_2_from_base_roster
      (1..4).each do |i|
        TournamentRoster.create(tournament: @tournament, team_id: 2, player_id: i, flag: 0)
      end
    end
    ...
    def create_conflicting_tournament_rosters
      ...
      TournamentRoster.create(tournament: @tournament, team_id: 2, player_id: 20, flag: 0)
